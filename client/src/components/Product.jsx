  ...
  return (
    <div className="border border-dashed rounded-md p-3 hover:border-blue-300">
      ...
      <div className="w-full h-[130px] md:h-[170px] relative overflow-hidden">
        ...
        <img src="/images/shirt.png" alt="" width={100} height={100} className="w-full h-full object-contain" />
      </div>

      {/* cart text */}
      <div className="relative pt-4 pb-0 md:pb-4">
        <Link to="/" className="line-clamp-2 text-sm md:text-base mb-1.5 text-black/80 hover:text-blue-600">
          High Quality Black T-shirt for man
        </Link>
        <Rating rating={4} iconClassName="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5" />
        <h5 className="mt-2.5 text-sm sm:text-lg">
          $20.00 <sub className="text-red-500 text-sm line-through">$3.00</sub>
        </h5>
