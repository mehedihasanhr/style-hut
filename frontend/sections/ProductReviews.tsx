          ...
          <div className="py-8 flex items-center gap-10 border-b border-dashed">
            ...
            <div className="md:ml-10">
              <div className="md:w-72">
                <RatingProgress rating={5} totalRating={180} total={300} />
                <RatingProgress rating={4} totalRating={100} total={300} />
                <RatingProgress rating={3} totalRating={12} total={300} />
                <RatingProgress rating={2} totalRating={8} total={300} />
                <RatingProgress rating={1} totalRating={0} total={300} />
              </div>
            </div>
          </div>
          {/* reviews */}
...
const RatingProgress = ({
  ...
  const percentage = total === 0 ? 0 : Math.ceil((totalRating / total) * 100)
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="w-12 text-sm md:text-base">{percentage}%</span>
    </div>
  )
}
